---
name: superteam
description: "Superteam entry point for OpenCode. Spawns a multi-agent team with adversarial feedback loops, contract-gated verification, and form-driven inner-loop orchestration."
triggers:
 - /superteam
---

# /superteam - Superteam Entry Point (OpenCode)
